# Generate ONLY fig_ramsey_paths_very_long_color.svg for validation
...
cat("Generating fig_ramsey_paths_very_long_color.svg...\n")
...
cat("✓ fig_ramsey_paths_very_long_color.svg generated\n")
