# Generate ONLY fig_neoclassical_growth_baseline_color.svg for validation
...
# Generate baseline color variant
cat("Generating fig_neoclassical_growth_baseline_color.svg...\n")
...
cat("✓ fig_neoclassical_growth_baseline_color.svg generated\n")
