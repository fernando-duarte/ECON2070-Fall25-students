# Generate ONLY fig_ramsey_paths_long_color.svg for validation
...
produce_paths_figure <- function(plot_opts, dest_filename) {
  ...
  par(family = base_family, mar = c(2, 2, 0.5, 0.5), oma = c(0, 0, 0, 0))
  render_paths_panel(model_tmp)
}

# Generate color variant
cat("Generating fig_ramsey_paths_long_color.svg...\n")
...
cat("✓ fig_ramsey_paths_long_color.svg generated\n")
