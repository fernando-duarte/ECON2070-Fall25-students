...
ol_img_dir <- function(chapter) {
  path("overleaf", "Fall 2025", "sections", chapter, "images")
}

# Notes figure base names (no extension)
notes_base <- function(chapter, name) {
  path("figures", "notes", "2025", chapter, name)
}
